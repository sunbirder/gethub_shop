...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
        <span id="general-tab" class="tab-front">通用信息</span><span id="detail-tab" class="tab-back">详细描述</span><span id="mix-tab" class="tab-back">其他信息</span><span id="properties-tab" class="tab-back">商品属性</span><span id="gallery-tab" class="tab-back">商品相册</span><span id="linkgoods-tab" class="tab-back">关联商品</span><span id="groupgoods-tab" class="tab-back">配件</span><span id="article-tab" class="tab-back">关联文章</span>
      </p>
    </div>

    <!-- tab body -->
    <div id="tabbody-div">
      <form onsubmit="return validate();" name="theForm" method="post" action="" enctype="multipart/form-data">
        <!-- 最大文件限制 -->
        ...
        <table width="90%" align="center" id="general-table" style="display: table;">
          <tbody><tr>
            ...
            <td><input type="text" size="30" style="float:left;color:;" value="" name="goods_name"><div onclick="ColorSelecter.Show(this);" id="font_color" style="background-color:;float:left;margin-left:2px;"><img style="margin-top:-1px;" src="__IMG__/color_selecter.gif"></div><input type="hidden" value="" name="goods_name_color" id="goods_name_color">&nbsp;
          ...
          <tr>
            <td class="label">
            <a title="点击此处查看提示信息" href="javascript:showNotice('noticeGoodsSN');"><img width="16" height="16" border="0" alt="点击此处查看提示信息" src="__IMG__/notice.gif"></a> 商品货号： </td>
            <td><input type="text" onblur="checkGoodsSn(this.value,'0')" size="20" value="" name="goods_sn"><span id="goods_sn_notice"></span><br>
            <span id="noticeGoodsSN" style="display:block" class="notice-span">如果您不输入商品货号，系统将自动生成一个唯一的货号。</span></td>
          </tr>
          <tr>
            <td class="label">商品分类：</td>
            <td><select onchange="hideCatDiv()" name="cat_id"><option value="0">请选择...</option><option value="1">手机类型</option><option value="5">&nbsp;&nbsp;&nbsp;&nbsp;双模手机</option><option value="2">&nbsp;&nbsp;&nbsp;&nbsp;CDMA手机</option><option value="16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;法国色粉</option><option value="3">&nbsp;&nbsp;&nbsp;&nbsp;GSM手机</option><option value="4">&nbsp;&nbsp;&nbsp;&nbsp;3G手机</option><option value="12">充值卡</option><option value="15">&nbsp;&nbsp;&nbsp;&nbsp;联通手机充值卡</option><option value="13">&nbsp;&nbsp;&nbsp;&nbsp;小灵通/固话充值卡</option><option value="14">&nbsp;&nbsp;&nbsp;&nbsp;移动手机充值卡</option><option value="6">手机配件</option><option value="8">&nbsp;&nbsp;&nbsp;&nbsp;耳机</option><option value="9">&nbsp;&nbsp;&nbsp;&nbsp;电池</option><option value="11">&nbsp;&nbsp;&nbsp;&nbsp;读卡器和内存卡</option><option value="7">&nbsp;&nbsp;&nbsp;&nbsp;充电器</option></select>
              ...
              <input name="addedCategoryName" size="10" class="text">
               ...
               <a class="special" title="隐藏" onclick="hideCatDiv()" href="javascript:void(0)"><</a>
               </span>
                              <span class="require-field">*</span>            </td>
          </tr>
          <tr>
            ...
            <td>
              <input type="button" class="button" onclick="addOtherCat(this.parentNode)" value="添加">
                          <select name="other_cat[]"><option value="0">请选择...</option><option value="1">手机类型</option><option value="5">&nbsp;&nbsp;&nbsp;&nbsp;双模手机</option><option value="2">&nbsp;&nbsp;&nbsp;&nbsp;CDMA手机</option><option value="16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;法国色粉</option><option value="3">&nbsp;&nbsp;&nbsp;&nbsp;GSM手机</option><option value="4">&nbsp;&nbsp;&nbsp;&nbsp;3G手机</option><option value="12">充值卡</option><option value="15">&nbsp;&nbsp;&nbsp;&nbsp;联通手机充值卡</option><option value="13">&nbsp;&nbsp;&nbsp;&nbsp;小灵通/固话充值卡</option><option value="14">&nbsp;&nbsp;&nbsp;&nbsp;移动手机充值卡</option><option value="6">手机配件</option><option value="8">&nbsp;&nbsp;&nbsp;&nbsp;耳机</option><option value="9">&nbsp;&nbsp;&nbsp;&nbsp;电池</option><option value="11">&nbsp;&nbsp;&nbsp;&nbsp;读卡器和内存卡</option><option value="7">&nbsp;&nbsp;&nbsp;&nbsp;充电器</option></select></td>
          </tr>
          <tr>
            <td class="label">商品品牌：</td>
            <td><select onchange="hideBrandDiv()" name="brand_id"><option value="0">请选择...</option><option value="1">诺基亚</option><option value="10">金立</option><option value="9">联想</option><option value="8">LG</option><option value="7">索爱</option><option value="6">三星</option><option value="5">夏新</option><option value="4">飞利浦</option><option value="3">多普达</option><option value="2">摩托罗拉</option><option value="11">  恒基伟业</option></select>
              ...
              <input name="addedBrandName" size="15" class="text">
               ...
               <a class="special" title="隐藏" onclick="hideBrandDiv()" href="javascript:void(0)"><<</a>
               </span>
                           </td>
          </tr>
                   <tr>
            <td class="label">选择供货商：</td>
            <td><select id="suppliers_id" name="suppliers_id">
        <option value="0">不指定供货商属于本店商品</option>
        <option value="1">北京供货商</option><option value="2">上海供货商</option>      </select></td>
          </tr>
                   <tr>
            <td class="label">本店售价：</td>
            <td><input type="text" onblur="priceSetted()" size="20" value="0" name="shop_price">
            <input type="button" onclick="marketPriceSetted()" value="按市场价计算">
            <span class="require-field">*</span></td>
          </tr>
                    <tr>
            <td class="label"><a title="点击此处查看提示信息" href="javascript:showNotice('noticeUserPrice');"><img width="16" height="16" border="0" alt="点击此处查看提示信息" src="__IMG__/notice.gif"></a>会员价格：</td>
            <td>
                            注册用户<span id="nrank_1"></span><input type="text" size="8" onkeyup="if(parseInt(this.value)<-1){this.value='-1';};set_price_note(1)" value="-1" name="user_price[]" id="rank_1">
              <input type="hidden" value="1" name="user_rank[]">
                            代销用户<span id="nrank_3"></span><input type="text" size="8" onkeyup="if(parseInt(this.value)<-1){this.value='-1';};set_price_note(3)" value="-1" name="user_price[]" id="rank_3">
              <input type="hidden" value="3" name="user_rank[]">
                            vip<span id="nrank_2"></span><input type="text" size="8" onkeyup="if(parseInt(this.value)<-1){this.value='-1';};set_price_note(2)" value="-1" name="user_price[]" id="rank_2">
          ...
          <!--商品优惠价格-->
          <tr>
            <td class="label"><a title="点击此处查看提示信息" href="javascript:showNotice('volumePrice');"><img width="16" height="16" border="0" alt="点击此处查看提示信息" src="__IMG__/notice.gif"></a>商品优惠价格：</td>
            <td>
              <table width="100%" align="center" id="tbody-volume">
                                <tbody><tr>
                  <td>
                                            <a onclick="addVolumePrice(this)" href="javascript:;">[+]</a>
                                          优惠数量 <input type="text" value="" size="8" name="volume_number[]">
                     优惠价格 <input type="text" value="" size="8" name="volume_price[]">
                  </td>
                </tr>
                              </tbody></table>
          ...
          <tr>
            ...
            <td><input type="text" size="20" value="0" name="market_price">
              <input type="button" onclick="integral_market_price()" value="取整数">
            </td>
          </tr>
          <tr>
            <td class="label"><a title="点击此处查看提示信息" href="javascript:showNotice('giveIntegral');"><img width="16" height="16" border="0" alt="点击此处查看提示信息" src="__IMG__/notice.gif"></a> 赠送消费积分数：</td>
            <td><input type="text" size="20" value="-1" name="give_integral">
            <br><span id="giveIntegral" style="display:block" class="notice-span">购买该商品时赠送消费积分数,-1表示按商品价格赠送</span></td>
          </tr>
          <tr>
            <td class="label"><a title="点击此处查看提示信息" href="javascript:showNotice('rankIntegral');"><img width="16" height="16" border="0" alt="点击此处查看提示信息" src="__IMG__/notice.gif"></a> 赠送等级积分数：</td>
            <td><input type="text" size="20" value="-1" name="rank_integral">
            <br><span id="rankIntegral" style="display:block" class="notice-span">购买该商品时赠送等级积分数,-1表示按商品价格赠送</span></td>
          </tr>
          <tr>
            <td class="label"><a title="点击此处查看提示信息" href="javascript:showNotice('noticPoints');"><img width="16" height="16" border="0" alt="点击此处查看提示信息" src="__IMG__/notice.gif"></a> 积分购买金额：</td>
            <td><input type="text" ;="" onblur="parseint_integral()" size="20" value="0" name="integral">
              <br><span id="noticPoints" style="display:block" class="notice-span">(此处需填写金额)购买该商品时最多可以使用积分的金额</span>
            </td>
          </tr>
          <tr>
            <td class="label"><label for="is_promote"><input type="checkbox" onclick="handlePromote(this.checked);" value="1" name="is_promote" id="is_promote"> 促销价：</label></td>
            <td id="promote_3"><input type="text" size="20" value="0" name="promote_price" id="promote_1" disabled=""></td>
          </tr>
          <tr id="promote_4">
            <td id="promote_5" class="label">促销日期：</td>
            <td id="promote_6">
              <input type="text" readonly="readonly" value="2013-12-29" size="12" id="promote_start_date" name="promote_start_date"><input type="button" class="button" value="选择" onclick="return showCalendar('promote_start_date', '%Y-%m-%d', false, false, 'selbtn1');" id="selbtn1" name="selbtn1" disabled=""> - <input type="text" readonly="readonly" value="2014-01-29" size="12" id="promote_end_date" name="promote_end_date"><input type="button" class="button" value="选择" onclick="return showCalendar('promote_end_date', '%Y-%m-%d', false, false, 'selbtn2');" id="selbtn2" name="selbtn2" disabled="">
            </td>
          </tr>
          <tr>
            ...
            <td>
              <input type="file" size="35" name="goods_img">
                            ...
                            <br><input type="text" name="goods_img_url" onfocus="if (this.value == '商品图片外部URL'){this.value='http://';this.style.color='#000';}" style="color:#aaa;" value="商品图片外部URL" size="40">
            </td>
          </tr>
          <tr id="auto_thumb_1">
            ...
            <td id="auto_thumb_3">
              <input type="file" size="35" name="goods_thumb" disabled="">
                              <img src="__IMG__/no.gif">
                            <br><input type="text" name="goods_thumb_url" onfocus="if (this.value == '商品缩略图外部URL'){this.value='http://';this.style.color='#000';}" style="color:#aaa;" value="商品缩略图外部URL" size="40" disabled="">
                            <br><label for="auto_thumb"><input type="checkbox" onclick="handleAutoThumb(this.checked)" value="1" checked="true" name="auto_thumb" id="auto_thumb">自动生成商品缩略图</label>            </td>
          </tr>
        </tbody></table>
        ...
        <table width="90%" style="display: none;" id="detail-table">
          <tbody><tr>
            <td><input type="hidden" style="display:none" value="<p>撒旦法撒 </p>" name="goods_desc" id="goods_desc"><input type="hidden" style="display:none" value="" id="goods_desc___Config"><iframe width="100%" scrolling="no" height="320" frameborder="0" src="../includes/fckeditor/editor/fckeditor.html?InstanceName=goods_desc&Toolbar=Normal" id="goods_desc___Frame" style="margin: 0px; padding: 0px; border: 0px none; background-color: transparent; background-image: none; width: 100%; height: 320px;"></iframe></td>
          </tr>
        </tbody></table>
        ...
        <table width="90%" align="center" style="display: none;" id="mix-table">
            ...
            <td><input type="text" size="20" value="" name="goods_weight"> <select name="weight_unit"><option selected="" value="1">千克</option><option value="0.001">克</option></select></td>
          </tr>
                              <tr>
            <td class="label"><a title="点击此处查看提示信息" href="javascript:showNotice('noticeStorage');"><img width="16" height="16" border="0" alt="点击此处查看提示信息" src="__IMG__/notice.gif"></a> 商品库存数量：</td>
<!--            <td><input type="text" name="goods_number" value="1" size="20"  /><br />-->
            <td><input type="text" size="20" value="1" name="goods_number"><br>
            <span id="noticeStorage" style="display:block" class="notice-span">库存在商品为虚货或商品存在货品时为不可编辑状态，库存数值取决于其虚货数量或货品数量</span></td>
          </tr>
          <tr>
            <td class="label">库存警告数量：</td>
            <td><input type="text" size="20" value="1" name="warn_number"></td>
          </tr>
                    <tr>
            <td class="label">加入推荐：</td>
            <td><input type="checkbox" value="1" name="is_best">精品 <input type="checkbox" value="1" name="is_new">新品 <input type="checkbox" value="1" name="is_hot">热销</td>
          </tr>
          <tr id="alone_sale_1">
            <td id="alone_sale_2" class="label">上架：</td>
            <td id="alone_sale_3"><input type="checkbox" checked="checked" value="1" name="is_on_sale"> 打勾表示允许销售，否则不允许销售。</td>
          </tr>
          <tr>
            <td class="label">能作为普通商品销售：</td>
            <td><input type="checkbox" checked="checked" value="1" name="is_alone_sale"> 打勾表示能作为普通商品销售，否则只能作为配件或赠品销售。</td>
          </tr>
          <tr>
            <td class="label">是否为免运费商品</td>
            <td><input type="checkbox" value="1" name="is_shipping"> 打勾表示此商品不会产生运费花销，否则按照正常运费计算。</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><textarea rows="3" cols="40" name="goods_brief"></textarea></td>
          </tr>
          <tr>
            <td class="label">
            <a title="点击此处查看提示信息" href="javascript:showNotice('noticeSellerNote');"><img width="16" height="16" border="0" alt="点击此处查看提示信息" src="__IMG__/notice.gif"></a> 商家备注： </td>
            <td><textarea rows="3" cols="40" name="seller_note"></textarea><br>
            <span id="noticeSellerNote" style="display:block" class="notice-span">仅供商家自己看的信息</span></td>
          </tr>
        </tbody></table>
        ...
        <!-- 属性与规格 -->
          ...
          <tbody><tr>
              <td class="label"><a title="点击此处查看提示信息" href="javascript:showNotice('noticeGoodsType');"><img width="16" height="16" border="0" alt="点击此处查看提示信息" src="__IMG__/notice.gif"></a>商品类型：</td>
              <td>
              ...
              <span id="noticeGoodsType" style="display:block" class="notice-span">请选择商品的所属类型，进而完善此商品的属性</span></td>
          </tr>
          <tr>
            <td style="padding:0" colspan="2" id="tbody-goodsAttr"><table width="100%" id="attrTable"></table></td>
          </tr>
        </tbody></table>
        ...
        <table width="90%" align="center" style="display: none;" id="gallery-table">
          ...
          <tr>
            <td>
              ...
              图片描述 <input type="text" size="20" name="img_desc[]">
        ...
        <table width="90%" align="center" style="display:none" id="linkgoods-table">
          ...
          <tbody><tr>
            <td colspan="3">
              ...
              <select name="cat_id1"><option value="0">所有分类</option><option value="1">手机类型</option><option value="5">&nbsp;&nbsp;&nbsp;&nbsp;双模手机</option><option value="2">&nbsp;&nbsp;&nbsp;&nbsp;CDMA手机</option><option value="16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;法国色粉</option><option value="3">&nbsp;&nbsp;&nbsp;&nbsp;GSM手机</option><option value="4">&nbsp;&nbsp;&nbsp;&nbsp;3G手机</option><option value="12">充值卡</option><option value="15">&nbsp;&nbsp;&nbsp;&nbsp;联通手机充值卡</option><option value="13">&nbsp;&nbsp;&nbsp;&nbsp;小灵通/固话充值卡</option><option value="14">&nbsp;&nbsp;&nbsp;&nbsp;移动手机充值卡</option><option value="6">手机配件</option><option value="8">&nbsp;&nbsp;&nbsp;&nbsp;耳机</option><option value="9">&nbsp;&nbsp;&nbsp;&nbsp;电池</option><option value="11">&nbsp;&nbsp;&nbsp;&nbsp;读卡器和内存卡</option><option value="7">&nbsp;&nbsp;&nbsp;&nbsp;充电器</option></select>
              ...
              <input type="button" onclick="searchGoods(sz1, 'cat_id1','brand_id1','keyword1')" class="button" value=" 搜索 ">
            </td>
          </tr>
          <!-- 商品列表 -->
          <tr>
          ...
          <tr>
            <td width="42%">
              <select multiple="true" ondblclick="sz1.addItem(false, 'add_link_goods', goodsId, this.form.elements['is_single'][0].checked)" style="width:100%" size="20" name="source_select1">
              </select>
            </td>
            <td align="center">
              <p><input type="radio" checked="checked" value="1" name="is_single">单向关联<br><input type="radio" value="0" name="is_single">双向关联</p>
              <p><input type="button" class="button" onclick="sz1.addItem(true, 'add_link_goods', goodsId, this.form.elements['is_single'][0].checked)" value=">>"></p>
              <p><input type="button" class="button" onclick="sz1.addItem(false, 'add_link_goods', goodsId, this.form.elements['is_single'][0].checked)" value=">"></p>
              <p><input type="button" class="button" onclick="sz1.dropItem(false, 'drop_link_goods', goodsId, elements['is_single'][0].checked)" value="<"></p>
              <p><input type="button" class="button" onclick="sz1.dropItem(true, 'drop_link_goods', goodsId, elements['is_single'][0].checked)" value="<"></p>
            </td>
            <td width="42%">
              <select ondblclick="sz1.dropItem(false, 'drop_link_goods', goodsId, elements['is_single'][0].checked)" multiple="" style="width:100%" size="20" name="target_select1">
                              </select>
            </td>
          </tr>
        </tbody></table>
        ...
        <table width="90%" align="center" style="display:none" id="groupgoods-table">
          ...
          <tbody><tr>
            <td colspan="3">
              <img width="26" height="22" border="0" alt="SEARCH" src="__IMG__/icon_search.gif">
              <select name="cat_id2"><option value="0">所有分类</option><option value="1">手机类型</option><option value="5">&nbsp;&nbsp;&nbsp;&nbsp;双模手机</option><option value="2">&nbsp;&nbsp;&nbsp;&nbsp;CDMA手机</option><option value="16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;法国色粉</option><option value="3">&nbsp;&nbsp;&nbsp;&nbsp;GSM手机</option><option value="4">&nbsp;&nbsp;&nbsp;&nbsp;3G手机</option><option value="12">充值卡</option><option value="15">&nbsp;&nbsp;&nbsp;&nbsp;联通手机充值卡</option><option value="13">&nbsp;&nbsp;&nbsp;&nbsp;小灵通/固话充值卡</option><option value="14">&nbsp;&nbsp;&nbsp;&nbsp;移动手机充值卡</option><option value="6">手机配件</option><option value="8">&nbsp;&nbsp;&nbsp;&nbsp;耳机</option><option value="9">&nbsp;&nbsp;&nbsp;&nbsp;电池</option><option value="11">&nbsp;&nbsp;&nbsp;&nbsp;读卡器和内存卡</option><option value="7">&nbsp;&nbsp;&nbsp;&nbsp;充电器</option></select>
              ...
              <input type="button" class="button" onclick="searchGoods(sz2, 'cat_id2', 'brand_id2', 'keyword2')" value=" 搜索 ">
            </td>
          </tr>
          <!-- 商品列表 -->
          <tr>
          ...
          <tr>
            <td width="42%">
              <select ondblclick="sz2.addItem(false, 'add_group_goods', goodsId, this.form.elements['price2'].value)" onchange="sz2.priceObj.value = this.options[this.selectedIndex].id" style="width:100%" size="20" name="source_select2">
              </select>
            </td>
            <td align="center">
              <p>价格<br><input type="text" size="6" name="price2"></p>
              <p><input type="button" class="button" onclick="sz2.addItem(false, 'add_group_goods', goodsId, this.form.elements['price2'].value)" value=">"></p>
              <p><input type="button" class="button" onclick="sz2.dropItem(false, 'drop_group_goods', goodsId, elements['is_single'][0].checked)" value="<"></p>
              <p><input type="button" class="button" onclick="sz2.dropItem(true, 'drop_group_goods', goodsId, elements['is_single'][0].checked)" value="<"></p>
            </td>
            <td width="42%">
              <select ondblclick="sz2.dropItem(false, 'drop_group_goods', goodsId, elements['is_single'][0].checked)" multiple="" style="width:100%" size="20" name="target_select2">
                              </select>
            </td>
          </tr>
        </tbody></table>
        ...
        <table width="90%" align="center" style="display:none" id="article-table">
          ...
          <tbody><tr>
            <td colspan="3">
              ...
              <input type="button" class="button" onclick="searchArticle()" value=" 搜索 ">
            </td>
          </tr>
          <!-- 文章列表 -->
          <tr>
          ...
          <tr>
            <td width="45%">
              <select ondblclick="sz3.addItem(false, 'add_goods_article', goodsId, this.form.elements['price2'].value)" multiple="" style="width:100%" size="20" name="source_select3">
              </select>
            </td>
            <td align="center">
              <p><input type="button" class="button" onclick="sz3.addItem(true, 'add_goods_article', goodsId, this.form.elements['price2'].value)" value=">>"></p>
              <p><input type="button" class="button" onclick="sz3.addItem(false, 'add_goods_article', goodsId, this.form.elements['price2'].value)" value=">"></p>
              <p><input type="button" class="button" onclick="sz3.dropItem(false, 'drop_goods_article', goodsId, elements['is_single'][0].checked)" value="<"></p>
              <p><input type="button" class="button" onclick="sz3.dropItem(true, 'drop_goods_article', goodsId, elements['is_single'][0].checked)" value="<"></p>
            </td>
            <td width="45%">
              <select ondblclick="sz3.dropItem(false, 'drop_goods_article', goodsId, elements['is_single'][0].checked)" multiple="" style="width:100%" size="20" name="target_select3">
                              </select>
            </td>
          </tr>
        </tbody></table>
