...
<script language="JavaScript">
      ...
      <table cellpadding="3" cellspacing="1">
        <tr>
          ...
          <!-- </tr>
            <tr>
              <td>
                <input type="checkbox" name="checkboxes[]" value="33" />
                33
              </td>
              <td class="first-cell" style="">
                <span onclick="listTable.edit(this, 'edit_goods_name', 33)">我的电脑</span>
              </td>
              <td>
                <span onclick="listTable.edit(this, 'edit_goods_sn', 33)">0017</span>
              </td>
              <td align="right">
                <span onclick="listTable.edit(this, 'edit_goods_price', 33)">99.00</span>
              </td>
              <td align="center">
                <img src="__IMG__/yes.gif" onclick="listTable.toggle(this, 'toggle_on_sale', 33)" />
              </td>
              <td align="center">
                <img src="__IMG__/no.gif" onclick="listTable.toggle(this, 'toggle_best', 33)" />
              </td>
              <td align="center">
                <img src="__IMG__/no.gif" onclick="listTable.toggle(this, 'toggle_new', 33)" />
              </td>
              <td align="center">
                <img src="__IMG__/no.gif" onclick="listTable.toggle(this, 'toggle_hot', 33)" />
              </td>
              <td align="center">
                <span onclick="listTable.edit(this, 'edit_sort_order', 33)">100</span>
              </td>
              <td align="right">
                <span onclick="listTable.edit(this, 'edit_goods_number', 33)">1</span>
              </td>
              <td align="center">
                <a href="../goods.php?id=33" target="_blank" title="查看">
                  <img src="__IMG__/icon_view.gif" width="16" height="16" border="0" />
                </a>
                <a href="goods.php?act=edit&goods_id=33&extension_code=" title="编辑">
                  <img src="__IMG__/icon_edit.gif" width="16" height="16" border="0" />
                </a>
                <a href="goods.php?act=copy&goods_id=33&extension_code=" title="复制">
                  <img src="__IMG__/icon_copy.gif" width="16" height="16" border="0" />
                </a>
                <a href="javascript:;" onclick="listTable.remove(33, '您确实要把该商品放入回收站吗？')" title="回收站">
  ...
  <?php if(is_array($goods_list)): foreach($goods_list as $key=>$goods): ?><tr>
    ...
    <td align="center">
      ...
      <a href="javascript:;" onclick="listTable.remove(<?php echo ($goods["goods_id"]); ?>, '<?php echo ($lang["trash_goods_confirm"]); ?>')" title="回收站">
        <img src="__IMG__/icon_trash.gif" width="16" height="16" border="0" />    
      </a>
      <!-- <?php if($goods["goods_type"] == 0): ?><a href="goods.php?act=product_list&goods_id=<?php echo ($goods["goods_id"]); ?>" title="<?php echo ($lang["item_list"]); ?>">
...
document.onmousemove=function(e)
{
  ...
  // 所有符合条件元素事件: obj.href非空, 这个函数是listTable.sort();
