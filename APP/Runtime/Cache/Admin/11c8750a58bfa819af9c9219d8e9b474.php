...
<script>
  $(function(){
    ...
    var capital=$("#capital").val();
      ...
      // ajax用户名密码提交
      // $.post("<?php echo U(GROUP_NAME.'Login/check_Login');?>",{name:username,pwd:password},function(msg){
          
      // })
      //ajax验证码提交
      $.post("<?php echo U(GROUP_NAME.'/Login/chk_code');?>",{code:capital},function(msg){
          if(msg==1){
...
<form method="post" action="<?php echo U(GROUP_NAME.'/Login/check_Login');?>" name='theForm' id="admin_login" >
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <tr>
      <td  class="first_td"></td><td colspan="2" align="right" id="code"><img src="<?php echo U(GROUP_NAME.'/Login/check');?>" width="145" height="20"  border="1" onclick= 'this.src=this.src+"?"+Math.random()' style="cursor: pointer;" />
      </td>
      <td></td>
